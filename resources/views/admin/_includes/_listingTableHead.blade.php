            ...
            <div class="d-flex justify-content-between flex-wrap p-1 mr-1">
                ...
                @if(in_array($name,$sortable))
                    <div class="sortingControls d-flex">
                             <span
                                 class=" mouse-pointer @if ($params['order_by']==$name  and $params['sort']=='asc' ) sorted asc text-warning @endif"
                                 data-order="{{$name}}"
                                 data-sort="asc">
                                    <i class="fas fa-sort-amount-up sorting_asc "></i>
                             </span>
                        <span
                            class="ml-1 mouse-pointer @if ($params['order_by']==$name  and $params['sort']=='desc' ) sorted desc text-warning @endif"
                            data-order="{{$name}}" data-sort="desc">
                                    <i class="fas fa-sort-amount-down sorting_asc"></i>
                              </span>
                    </div>
            </div>
            @endif
