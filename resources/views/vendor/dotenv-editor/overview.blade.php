            ...
            {{-- Overview --}}
                      ...
                      <div :class=" (views[2].active?' show active':'') +' tab-pane fade '" id="tab_env_2" role="tabpanel">
                        {{-- Create Backup --}}
                          ...
                          <div class="">
                                <a href="{{ route(config('dotenveditor.route.as'). "createbackup") }}" class="btn btn-primary">
                                    {!! trans('dotenv-editor::views.backup_create') !!}
                                </a>
                                <a href="{{ route(config('dotenveditor.route.as'). "download") }}" class="btn btn-primary">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                   <div class="btn-group">
                                                    ...
                                                    <a class="btn btn-info" href="{{ route(config('dotenveditor.route.as'). "download", $backup['unformatted']) }}">
                                                        <span class="fa fa-download" title="{!! trans('dotenv-editor::views.backup_table_options_download') !!}"></span>
                                                    </a>
                                                    <a class="btn btn-danger" href="{{ route(config('dotenveditor.route.as'). "deletebackup" , $backup["unformatted"]) }}"
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" class="btn " data-dismiss="modal">{!! trans('dotenv-editor::views.backup_modal_close') !!}</button>

                                        <a href="{{ route(config('dotenveditor.route.as'). "deletebackup", $backup["unformatted"]) }}" class="btn btn-danger">
                      ...
                      <div :class=" (views[3].active?' show active':'')+' tab-pane fade '" id="tab_env_3" role="tabpanel">
                          <div class="card-body">
                              <h5 class="card-title">{!! trans('dotenv-editor::views.upload_title') !!}</h5>
                                ...
                                <form method="post" action="{{ route(config('dotenveditor.route.as'). "upload") }}" enctype="multipart/form-data">
                                    <div class="form-group">
